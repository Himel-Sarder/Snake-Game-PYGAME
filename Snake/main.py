...
pygame.display.set_caption("Noob Snake")
...
# Load the eat sound
pygame.mixer.init()
eat_sound = pygame.mixer.Sound("Eating.mp3")  # Replace with your sound file

# Load the game over sound
game_over_sound = pygame.mixer.Sound("GameOver.wav")  # Replace with your game over sound file

# Load the background music
pygame.mixer.music.load('music_music.mp3')  # Replace with your music file
...
background_image = pygame.image.load("555.png")

# Load the menu image
menu_image = pygame.image.load("menu_image.png")

# Load the credit image
#credit_image = pygame.image.load("nice.png")
...
def main_menu():
    ...
    if menu_state == "credit":
        ...
        credit_text5 = credit_font.render("**Contact : info.himelcse@gmail.com", 1, "black")
        credit_text6 = credit_font.render("Thank you for playing Noob Snake!", 1, "black")
        ...
        window.blit(credit_text5, (40, 310))
        window.blit(credit_text6, (40, 350))
